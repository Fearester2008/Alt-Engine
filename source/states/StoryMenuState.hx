...
class StoryMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		leftArrow.antialiasing = EnginePreferences.data.antialiasing;
		...
		sprDifficulty.antialiasing = EnginePreferences.data.antialiasing;
		difficultySelectors.add(sprDifficulty);

		rightArrow = new FlxSprite(leftArrow.x + 376, leftArrow.y);
		rightArrow.antialiasing = EnginePreferences.data.antialiasing;
	...
	{
		AppUtil.setAppData(AppController.appName, AppController.altEngineVersion + AppController.stage, "In Story");
