...
class Tank extends BaseStage
{
	...
	override function create()
	{
		...
		if(!EnginePreferences.data.lowQuality)
		{
		...
		if(!EnginePreferences.data.lowQuality) foregroundSprites.add(new BGSprite('tank1', -300, 750, 2, 0.2, ['fg']));
		foregroundSprites.add(new BGSprite('tank2', 450, 940, 1.5, 1.5, ['foreground']));
		if(!EnginePreferences.data.lowQuality) foregroundSprites.add(new BGSprite('tank4', 1300, 900, 1.5, 1.5, ['fg']));
		foregroundSprites.add(new BGSprite('tank5', 1620, 700, 1.5, 1.5, ['fg']));
		if(!EnginePreferences.data.lowQuality) foregroundSprites.add(new BGSprite('tank3', 1300, 1200, 3.5, 2.5, ['fg']));
	...
	{
		if(!EnginePreferences.data.lowQuality) tankWatchtower.dance();
	...
	function prepareCutscene()
	{
		...
		tankman.antialiasing = EnginePreferences.data.antialiasing;
		addBehindDad(tankman);

		tankman2 = new FlxSprite(16, 312);
		tankman2.antialiasing = EnginePreferences.data.antialiasing;
		tankman2.alpha = 0.000001;

		gfDance = new FlxSprite(gf.x - 107, gf.y + 140);
		gfDance.antialiasing = EnginePreferences.data.antialiasing;

		gfCutscene = new FlxSprite(gf.x - 104, gf.y + 122);
		gfCutscene.antialiasing = EnginePreferences.data.antialiasing;

		picoCutscene = new FlxSprite(gf.x - 849, gf.y - 264);
		picoCutscene.antialiasing = EnginePreferences.data.antialiasing;

		boyfriendCutscene = new FlxSprite(boyfriend.x + 5, boyfriend.y + 20);
		boyfriendCutscene.antialiasing = EnginePreferences.data.antialiasing;
