...
class ModsMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		startX -= 100;
		buttonTop = new FlxButton(startX, 0, "TOP", function() {		for (i in 0...curSelected) //so it shifts to the top instead of replacing the top one
			{
				moveMod(-1, true);
			}
	...
	{
		AppUtil.setAppData(VersionStuff.appName, VersionStuff.altEngineVersion + VersionStuff.stage, "In The Mods Menu.");
