...
class AchievementsMenuState extends MusicBeatState
{
	...
	public var unlockedAchievementsInPlayState:Array<Dynamic> = [];
	...
	override function update(elapsed:Float) {
		AppUtil.setAppData(AppController.appName, AppController.altEngineVersion + AppController.stage, "In Achievements Menu: " + options[curSelected].displayName);
