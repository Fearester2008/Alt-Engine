...
class AchievementsMenuState extends MusicBeatState
{
	...
	override function create() {
		...
		menuBG.antialiasing = EnginePreferences.data.antialiasing;
	...
	override function update(elapsed:Float) {
		AppUtil.setAppData(AppController.appName, AppController.altEngineVersion + AppController.stage, "In Achievements Menu: " + options[curSelected]);
