...
class FlxHitbox extends FlxSpriteGroup {
	...
	public function new(?alphaAlt:Float = 0.75, ?antialiasingAlt:Bool = true) {
		...
		hitbox_hint.loadGraphic(FlxGraphic.fromFrame(FlxAtlasFrames.fromSparrow(Assets.getBitmapData('assets/androidcontrols/hitbox_hint.png'));
	...
	public function getFrames():FlxAtlasFrames {
		return loadGraphic(FlxGraphic.fromFrame(FlxAtlasFrames.fromSparrow(Assets.getBitmapData('assets/androidcontrols/hitbox.png')
	}
