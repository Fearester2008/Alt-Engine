...
class GameplayChangersSubstate extends MusicBeatSubstate
{
	...
	{
		AppUtil.setAppData(AppController.appName, AppController.altEngineVersion + AppController.stage, "In Gameplay Settings - " + optionsArray[curSelected].name + ": " + optionsArray[curSelected].getValue());
...
class GameplayOption
{
	...
	private var variable:String = null; //Variable from EnginePreferences.hx's gameplaySettings
	...
	{
		return EnginePreferences.data.gameplaySettings.get(variable);
	}
	public function setValue(value:Dynamic)
	{
		EnginePreferences.data.gameplaySettings.set(variable, value);
	}
