...
class LuaUtils
{
	...
	inline public static function getBarObject(name:String):Bar
		{
			return #if LUA_ALLOWED PlayState.instance.modchartBars.exists(name) ? PlayState.instance.modchartBars.get(name) : #end Reflect.getProperty(PlayState.instance, name);
		}
