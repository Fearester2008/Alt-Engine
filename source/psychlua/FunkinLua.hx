...
class FunkinLua {
	...
	public function new(scriptName:String) {
		...
		set('ratingName', '');
		set('ratingFC', '');
		set('psychEngineVersion', AppController.psychEngineVersion.trim());
		set('altEngineVersion', AppController.altEngineVersion.trim() + AppController.stage.trim());
		...
		set('downscroll', EnginePreferences.data.downScroll);
		set('middlescroll', EnginePreferences.data.middleScroll);
		set('framerate', EnginePreferences.data.framerate);
		set('ghostTapping', EnginePreferences.data.ghostTapping);
		set('hideHud', EnginePreferences.data.hideHud);
		set('timeBarType', EnginePreferences.data.timeBarType);
		set('scoreZoom', EnginePreferences.data.scoreZoom);
		set('cameraZoomOnBeat', EnginePreferences.data.camZooms);
		set('flashingLights', EnginePreferences.data.flashing);
		set('noteOffset', EnginePreferences.data.noteOffset);
		set('healthBarAlpha', EnginePreferences.data.healthBarAlpha);
		set('noResetButton', EnginePreferences.data.noReset);
		set('lowQuality', EnginePreferences.data.lowQuality);
		set('shadersEnabled', EnginePreferences.data.shaders);
		set('scriptName', scriptName);
		set('currentModDirectory', Mods.currentModDirectory);

		// Noteskin/Splash
		set('noteSkin', EnginePreferences.data.noteSkin);
		set('noteSkinPostfix', Note.getNoteSkinPostfix());
		set('splashSkin', EnginePreferences.data.splashSkin);
		set('splashSkinPostfix', NoteSplash.getSplashSkinPostfix());
		set('splashAlpha', EnginePreferences.data.splashAlpha);
