...
class HScript extends SScript
{
	...
	override function preset()
	{
		...
		set('EnginePreferences', EnginePreferences);
		...
		{			
			if(funk != null) Lua_helper.add_callback(funk.lua, name, func);
		...
		set('addHaxeLibrary', function(libName:String, ?libPackage:String = '') {
			try {
				...
				if(funk != null)
				{
					...
					msg = origin + ":" + funk.lastCalledFunction + " - " + msg;
				}
				else msg = '$origin - $msg';
				FunkinLua.luaTrace(msg, funk == null, false, FlxColor.RED);
			}
		});
		set('funk', funk);
		set('this', this);
		...
		set('addBehindGF', function(obj:FlxObject) PlayState.instance.addBehindGF(obj));
		set('addBehindDad', function(obj:FlxObject) PlayState.instance.addBehindDad(obj));
		set('addBehindBF', function(obj:FlxObject) PlayState.instance.addBehindBF(obj));
		set('insert', function(pos:Int, obj:FlxObject) PlayState.instance.insert(pos, obj));
		set('remove', function(obj:FlxBasic, splice:Bool = false) PlayState.instance.remove(obj, splice));
		set('trace', function(obj:String) trace(obj));
		#end
	}
	...
	public function executeCode(?funcToRun:String = null, ?funcArgs:Array<Dynamic> = null):TeaCall
	{
		...
		if (!callValue.succeeded)
		{
			...
			if (e != null)
			{
				...
				if(funk != null) msg = origin + ":" + funk.lastCalledFunction + " - " + msg;
				else msg = '$origin - $msg';
				FunkinLua.luaTrace(msg, funk == null, false, FlxColor.RED);
			}
			return null;
	...
	{
		#if LUA_ALLOWED
		Lua_helper.add_callback(funk.lua, "runHaxeCode", function(codeToRun:String, ?varsToBring:Any = null, ?funcToRun:String = null, ?funcArgs:Array<Dynamic> = null):Dynamic {
		...
		Lua_helper.add_callback(funk.lua, "runHaxeFunction", function(funcToRun:String, ?funcArgs:Array<Dynamic> = null) {
			#if (SScript >= "3.0.0")
