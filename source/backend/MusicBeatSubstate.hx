...
class MusicBeatSubstate extends FlxSubState
{
	...
	public function addVirtualPad(?DPad:FlxDPadMode, ?Action:FlxActionMode) {
		_virtualpad = new FlxVirtualPad(DPad, Action, 0.75, EnginePreferences.data.antialiasing);
		add(_virtualpad);
	...
	private function updateCurStep():Void
	{
		...
		var shit = ((Conductor.songPosition - EnginePreferences.data.noteOffset) - lastChange.songTime) / lastChange.stepCrochet;
