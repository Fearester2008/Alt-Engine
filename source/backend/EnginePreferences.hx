...
class SaveVariables {
  ...
  //Mobile Stuff
	...
	//Alt Engine Preferences
	public var iconBop:String = 'Alt';
	public var hud:String = 'Psych Engine';
    public var lightStrums:Bool = true;
	public var noteIntro:Bool = false;
	//public var language:String = 'English'; //in recreation
    public var fpsStyle:String = 'Official';
	public var winIcon:Bool = true;
	public var results:Bool = false;
	public var beatMode:String = 'Both camera';
	public var resolution:String = '1280x720'; //dont change it if you not have this resolution
	public var judgementCounter:String = 'Counter';
	public var customAppTitle:Bool = true;
	public var enableToggleVolume:Bool = false;
...
class EnginePreferences {
	...
	public static function reloadVolumeKeys()
	{
		...
		EnginePreferences.toggleVolumeKeys(EnginePreferences.data.enableToggleVolume);
	}
