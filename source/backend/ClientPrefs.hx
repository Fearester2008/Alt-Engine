...
class ClientPrefs {
	...
	public static var hudStyle:String = 'Psych Engine';
	...
	public static var enableToggleVolume:Bool = false;
	...
	public static function saveSettings() {
		...
		FlxG.save.data.enableToggleVolume = enableToggleVolume;
	...
	public static function loadPrefs() {
		...
		if(FlxG.save.data.enableToggleVolume != null) {
			enableToggleVolume = FlxG.save.data.enableToggleVolume;
		}
		...
		if(FlxG.save.data.stacking != null) {
			stacking = FlxG.save.data.stacking;
		}
	...
	inline public static function getGameplaySetting(name:String, ?defaultValue:Dynamic = 1):Dynamic {
	...
	public static function toggleVolumeKeys(enable:Bool = true)
	{
		if(enable)
		{
