...
class VisualsUISubState extends BaseOptionsMenu
{
	...
	public function new()
	{
		...
		var option:Option = new Option('Splitted Amplitude',
			"If unchecked, Voices Amplitude will be set with Instrumental Amplitude in One Bar.",
			'splittedAmplitude',
			'bool');
		addOption(option);
	...
	function onChangeFPSStyle() {
		Main.fpsVar.style = ClientPrefs.data.fpsStyle;
	}
}
