...
class OptionsState extends MusicBeatState
{
	...
	override function create() {
		...
		#if android
		var tipText:FlxText = new FlxText(10, 12, 1280, 'Press X to Go In Android Controls Menu.\nPress Y to Go In Android Hitbox Settings', 16);
