...
class GraphicsSettingsSubState extends BaseOptionsMenu
{
	public function new()
	{
		...
		var option:Option = new Option('Low Quality', //Name
			...
			'Если флажок установлен, убираются некоторые детали, уменьшающие загрузочные тайминги и улучшают производительность игры.',
		...
		var option:Option = new Option('Screen Resolution',
		 ...
		 'Выберите ваше предпочтительное разрешение экрана.',
		 'screenRes',
		 'string',
		 '1280x720',
		 ['640x360', '852x480','960x540','1280x720','2560×1440','1960x1080', '3840x2160', '7680x4320']);
		addOption(option);
