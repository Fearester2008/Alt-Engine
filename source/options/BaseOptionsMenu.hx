...
class BaseOptionsMenu extends MusicBeatSubstate
{
	...
	{
		AppUtil.setAppData(AppController.appName, AppController.altEngineVersion + AppController.stage, "In " + title + " - " + optionsArray[curSelected].name + " " + optionsArray[curSelected].getValue());
